...
export default function AdminWelcomeOptions() {
  ...
  const configSections: DropdownMenuSection[] = [
    ...
    {
      items: [
        { label: "Restablecer configuración", isDanger: true, onClick: () => console.log("Restablecer configuración") },
      ],
    },
  ];
  ...
  return (
    <div class="space-y-6">
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-6">Como administrador, tienes acceso completo a todas las funcionalidades del sistema.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-amber-50 p-5 rounded-lg border border-amber-200">
            ...
            <div class="flex justify-between items-center">
              <a href="/admin/settings" class="text-amber-600 hover:underline">Ir a configuración →</a>
              <DropdownMenu
                buttonText="Opciones"
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <a href="/admin/users?action=create" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
          ...
          <a href="/admin/settings" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
