  ...
  return (
    <div class="space-y-6">
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-6">Como Product Owner, eres responsable de maximizar el valor del producto y gestionar el backlog.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-indigo-50 p-5 rounded-lg border border-indigo-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Visualiza y gestiona los proyectos donde eres Product Owner.</p>
              </div>
          ...
          <div class="bg-amber-50 p-5 rounded-lg border border-amber-200">
            ...
            <div class="flex justify-between items-center">
              <a href="/backlog" class="text-amber-600 hover:underline">Ver backlog →</a>
              <DropdownMenu
                buttonText="Opciones"
          ...
          <div class="bg-blue-50 p-5 rounded-lg border border-blue-200">
            ...
            <div class="flex justify-between items-center">
              <a href="/reports" class="text-blue-600 hover:underline">Ver reportes →</a>
              <DropdownMenu
                buttonText="Opciones"
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <a href="/backlog/plan-sprint" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span class="text-sm font-medium text-gray-700">Planificar Sprint</span>
          </a>
          <a href="/reports" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
