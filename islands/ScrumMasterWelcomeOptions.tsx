...
export default function ScrumMasterWelcomeOptions() {
  ...
  const sprintsSections: DropdownMenuSection[] = [
    {
      items: [
        ...
        { label: "Sprints activos", href: "/sprints?filter=active" },
    ...
    {
      items: [
        { label: "Configurar duración", onClick: () => console.log("Configurar duración") },
      ],
    },
  ];
  ...
  const meetingsSections: DropdownMenuSection[] = [
    ...
    {
      items: [
        { label: "Programar reunión", href: "/meetings/schedule" },
      ],
    },
  ];
  ...
  const impedimentsSections: DropdownMenuSection[] = [
    ...
    {
      items: [
        { label: "Asignar responsable", href: "/impediments/assign" },
      ],
    },
  ];
  ...
  return (
    <div class="space-y-6">
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-6">Como Scrum Master, eres responsable de facilitar el proceso Scrum y ayudar al equipo a mejorar continuamente.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-blue-50 p-5 rounded-lg border border-blue-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Visualiza y gestiona los proyectos donde eres Scrum Master.</p>
              </div>
          ...
          <div class="bg-purple-50 p-5 rounded-lg border border-purple-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Planifica y administra los sprints de tus proyectos.</p>
              </div>
            ...
            <div class="flex justify-between items-center">
              <a href="/sprints" class="text-purple-600 hover:underline">Gestionar sprints →</a>
              <DropdownMenu
                buttonText="Opciones"
          ...
          <div class="bg-green-50 p-5 rounded-lg border border-green-200">
            ...
            <div class="flex justify-between items-center">
              <a href="/meetings" class="text-green-600 hover:underline">Gestionar reuniones →</a>
              <DropdownMenu
                buttonText="Opciones"
          ...
          <div class="bg-amber-50 p-5 rounded-lg border border-amber-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Registra y da seguimiento a los impedimentos del equipo.</p>
              </div>
            ...
            <div class="flex justify-between items-center">
              <a href="/impediments" class="text-amber-600 hover:underline">Ver impedimentos →</a>
              <DropdownMenu
                buttonText="Opciones"
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <a href="/sprints/create" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
          ...
          <a href="/meetings/schedule" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span class="text-sm font-medium text-gray-700">Programar Reunión</span>
          </a>
          <a href="/impediments/create" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span class="text-sm font-medium text-gray-700">Registrar Impedimento</span>
          </a>
          <a href="/meetings/daily" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
