  ...
  return (
    <div class="space-y-6">
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-6">Como miembro del equipo de desarrollo, eres responsable de entregar incrementos de producto de alta calidad en cada sprint.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-blue-50 p-5 rounded-lg border border-blue-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Visualiza los proyectos en los que participas como desarrollador.</p>
              </div>
          ...
          <div class="bg-green-50 p-5 rounded-lg border border-green-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Gestiona tus tareas asignadas y actualiza su progreso.</p>
              </div>
            ...
            <div class="flex justify-between items-center">
              <a href="/tasks" class="text-green-600 hover:underline">Ver tareas →</a>
              <DropdownMenu
                buttonText="Opciones"
          ...
          <div class="bg-purple-50 p-5 rounded-lg border border-purple-200">
            ...
            <div class="flex justify-between items-center">
              <a href="/impediments/create" class="text-purple-600 hover:underline">Reportar →</a>
              <DropdownMenu
                buttonText="Opciones"
          ...
          <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">Añade más información a tu perfil para mejorar tu experiencia.</p>
              </div>
            ...
            <div class="flex justify-between items-center">
              <a href="/profile" class="text-blue-600 hover:underline">Editar perfil →</a>
              <DropdownMenu
                buttonText="Opciones"
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <a href="/tasks?filter=pending" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
          ...
          <a href="/tasks/update-status" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="/tasks/log-time" class="bg-gray-100 hover:bg-gray-200 p-4 rounded-lg text-center transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mb-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
