...
/**
 * SCRIPT MAESTRO PARA POBLAR TODO EL SISTEMA
 * Este script ejecuta la población completa y actualizada de TODAS las funcionalidades
 * 
 * Ejecutar con: deno run --unstable-kv -A scripts/populate-everything.ts
 */
...
async function populateEverything() {
  ...
  try {
    ...
    const userData = [
      // Administradores
      { username: "admin", email: "admin@admin.com", password: "admin123", firstName: "Admin", lastName: "Sistema", role: UserRole.ADMIN },
      { username: "prof.martinez", email: "martinez@universidad.edu", password: "prof123", firstName: "María Elena", lastName: "Martínez", role: UserRole.ADMIN },
      { username: "prof.rodriguez", email: "rodriguez@universidad.edu", password: "prof123", firstName: "Carlos Alberto", lastName: "Rodríguez", role: UserRole.ADMIN },
      
      // Product Owners
      { username: "po.garcia", email: "garcia@universidad.edu", password: "po123", firstName: "Ana Sofía", lastName: "García", role: UserRole.PRODUCT_OWNER },
      { username: "po.lopez", email: "lopez.po@universidad.edu", password: "po123", firstName: "Luis Fernando", lastName: "López", role: UserRole.PRODUCT_OWNER },
      { username: "po.mendoza", email: "mendoza@universidad.edu", password: "po123", firstName: "Patricia", lastName: "Mendoza", role: UserRole.PRODUCT_OWNER },
      
      // Scrum Masters
      { username: "sm.fernandez", email: "fernandez@universidad.edu", password: "sm123", firstName: "Carmen Rosa", lastName: "Fernández", role: UserRole.SCRUM_MASTER },
      { username: "sm.torres", email: "torres@universidad.edu", password: "sm123", firstName: "Diego Alejandro", lastName: "Torres", role: UserRole.SCRUM_MASTER },
      { username: "sm.silva", email: "silva@universidad.edu", password: "sm123", firstName: "Roberto", lastName: "Silva", role: UserRole.SCRUM_MASTER },
      
      // Estudiantes
      { username: "dev.perez", email: "perez@estudiante.edu", password: "dev123", firstName: "Juan Carlos", lastName: "Pérez", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.gonzalez", email: "gonzalez@estudiante.edu", password: "dev123", firstName: "María Fernanda", lastName: "González", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.sanchez", email: "sanchez@estudiante.edu", password: "dev123", firstName: "Pedro Antonio", lastName: "Sánchez", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.torres", email: "torres.dev@estudiante.edu", password: "dev123", firstName: "Laura Beatriz", lastName: "Torres", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.morales", email: "morales@estudiante.edu", password: "dev123", firstName: "Diego Sebastián", lastName: "Morales", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.castro", email: "castro@estudiante.edu", password: "dev123", firstName: "Sofía Alejandra", lastName: "Castro", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.ruiz", email: "ruiz@estudiante.edu", password: "dev123", firstName: "Andrés Felipe", lastName: "Ruiz", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.herrera", email: "herrera@estudiante.edu", password: "dev123", firstName: "Valentina", lastName: "Herrera", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.jimenez", email: "jimenez@estudiante.edu", password: "dev123", firstName: "Sebastián", lastName: "Jiménez", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.vargas", email: "vargas@estudiante.edu", password: "dev123", firstName: "Isabella", lastName: "Vargas", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.ramirez", email: "ramirez@estudiante.edu", password: "dev123", firstName: "Camilo", lastName: "Ramírez", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.ortega", email: "ortega@estudiante.edu", password: "dev123", firstName: "Natalia", lastName: "Ortega", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.medina", email: "medina@estudiante.edu", password: "dev123", firstName: "Gabriel", lastName: "Medina", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.rojas", email: "rojas@estudiante.edu", password: "dev123", firstName: "Daniela", lastName: "Rojas", role: UserRole.TEAM_DEVELOPER },
      { username: "dev.vega", email: "vega@estudiante.edu", password: "dev123", firstName: "Mateo", lastName: "Vega", role: UserRole.TEAM_DEVELOPER },
    ];
    ...
    const projectsData = [
      {
        ...
        poIndex: 0, smIndex: 0, devIndexes: [0, 1, 2, 3, 4],
      },
      {
        ...
        poIndex: 1, smIndex: 1, devIndexes: [5, 6, 7, 8, 9],
      },
      {
        ...
        poIndex: 2, smIndex: 2, devIndexes: [10, 11, 12, 13],
      },
    ];
    ...
    for (const project of projects) {
      ...
      for (const storyData of stories) {
        const story = await createUserStory(
          { ...storyData, projectId: project.id },
    ...
    // Continuar con el resto de funcionalidades...
    console.log("\n🎉 DATOS BÁSICOS CREADOS EXITOSAMENTE");
    console.log("Ejecuta los scripts específicos para completar:");
    console.log("• deno run -A --unstable-kv scripts/populate-rubrics.ts");
    console.log("• deno run -A --unstable-kv scripts/populate-evaluations.ts");
    console.log("• deno run -A --unstable-kv scripts/populate-metrics.ts");

    return { users, projects, userStories: allUserStories };

  } catch (error) {
    console.error("❌ Error poblando sistema:", error instanceof Error ? error.message : String(error));
    throw error;
  }
}
